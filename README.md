...
1. **Route HLP**
    * Extends `\dlds\giixer\components\helpers\GxRouteHelper` or your custom class set in `helperRouteBaseClass` [option](option-helper-route-base-class)
...
2. **Rule HLP**
    * Extends `\dlds\giixer\components\helpers\GxUrlRuleHelper` or your custom class set in `helperRuleBaseClass` [option](option-helper-rule-base-class)
...
[option-helper-route-base-class]:
