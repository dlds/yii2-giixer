...
namespace dlds\giixer\generators\crud;
...
class Generator extends \yii\gii\generators\crud\Generator {
    ...
    const TMPL_NAME = 'metronic';

    public $modelClass;
    public $controllerClass;
    public $viewPath;
    public $baseControllerClass = 'dlds\giixer\components\GxController';
    ...
    /**
     * Returns the root path to the metronic code template files.
     ...
     */
    public function metronicTemplate()
    {
        $class = new ReflectionClass($this);
